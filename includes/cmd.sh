...
CMDZIP="/usr/bin/zip"
	...
	CMDCLEAR="/usr/bin/clear"
	CMDCP="/usr/bin/cp" #
	CMDCOMPOSER="/usr/bin/composer"
	CMPUFREQSET="/usr/bin/cpufreq-set"
	CMDCRONTAB="/usr/bin/crontab"
	CMDCURL="/usr/bin/curl"
	CMDCUT="/usr/bin/cut"
	CMDDATE="/usr/bin/date" #
	...
	CMDRTORRENT="/usr/local/bin/rtorrent"
	CMDSED="/usr/bin/sed" #
	CMDSERVICE="/usr/sbin/service"
	CMDSH="/usr/bin/sh"
	CMDSLEEP="/usr/bin/sleep" #
	CMDSTAT="/usr/bin/stat"
	CMDSU="/usr/bin/su" #
	CMDSYSTEMCTL="/usr/bin/systemctl" #
	CMDTAIL="/usr/bin/tail"
